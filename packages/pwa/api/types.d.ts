/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./api/types.d.ts` (hash: c71a20abd2d892f8aa688a6e462be1b5)
// Runtime types generated with workerd@1.20260625.1 2025-11-18 nodejs_als,nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	EMAIL: SendEmail;
	ASSETS: Fetcher;
	APPLE_APP_BUNDLE_IDENTIFIER: "app.trizum.capacitor";
	APPLE_SERVICE_ID: "app.trizum.capacitor.si";
	AUTH_EMAIL_FROM: "trizum <noreply@trizum.app>";
	BETTER_AUTH_ALLOWED_HOSTS: "trizum.app,*.horusdev.workers.dev,localhost:5173,localhost:8787,127.0.0.1:5173,127.0.0.1:8787";
	BETTER_AUTH_TRUSTED_ORIGINS: "https://trizum.app,https://*.horusdev.workers.dev,capacitor://localhost,ionic://localhost,https://localhost,http://localhost,http://localhost:5173,http://localhost:8787";
	BETTER_AUTH_URL: "https://trizum.app";
	GOOGLE_ANDROID_APK_CLIENT_ID: "554871818976-9el2tt5b2fj1quodn14be8jncpefij7v.apps.googleusercontent.com";
	GOOGLE_ANDROID_GOOGLE_PLAY_CLIENT_ID: "554871818976-bps9ha7q5qhop0i8nt8jfa2l2mu48a6a.apps.googleusercontent.com";
	GOOGLE_IOS_CLIENT_ID: "554871818976-adac4tobqolhrgp7e64siieslsc2jf84.apps.googleusercontent.com";
	GOOGLE_WEB_CLIENT_ID: "554871818976-e3p8ou802d8746n0se8dv20ba3gnfi0g.apps.googleusercontent.com";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APPLE_APP_BUNDLE_IDENTIFIER" | "APPLE_SERVICE_ID" | "AUTH_EMAIL_FROM" | "BETTER_AUTH_ALLOWED_HOSTS" | "BETTER_AUTH_TRUSTED_ORIGINS" | "BETTER_AUTH_URL" | "GOOGLE_ANDROID_APK_CLIENT_ID" | "GOOGLE_ANDROID_GOOGLE_PLAY_CLIENT_ID" | "GOOGLE_IOS_CLIENT_ID" | "GOOGLE_WEB_CLIENT_ID">> {}
}
