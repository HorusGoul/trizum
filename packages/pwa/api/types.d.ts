/* eslint-disable */
// Generated by Wrangler by running `wrangler types --path=./api/types.d.ts` (hash: a23a6dc2147c919f149a727c5b50a8bf)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		BETTER_AUTH_ALLOWED_HOSTS: "trizum.app,*.workers.dev,localhost:5173,localhost:8787,127.0.0.1:5173,127.0.0.1:8787";
		BETTER_AUTH_TRUSTED_ORIGINS: "https://trizum.app,capacitor://localhost,ionic://localhost,http://localhost,http://localhost:5173,http://localhost:8787";
