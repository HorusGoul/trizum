            ...
            <div className="text-accent-600 dark:text-accent-400 flex items-center justify-center gap-2 text-sm">
              ...
              {commit !== "unknown" && (
                <a
                  ...
                  className="bg-accent-100 text-accent-700 hover:bg-accent-200 hover:text-accent-900 dark:bg-accent-800 dark:text-accent-300 dark:hover:bg-accent-700 dark:hover:text-accent-100 rounded px-1 pt-1 font-mono leading-none"
                >
                  {commit}
                </a>
              )}
