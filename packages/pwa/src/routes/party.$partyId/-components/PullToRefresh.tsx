  ...
  return (
    <LazyMotion features={domAnimation}>
      <motion.div ref={rootRef} className="flex min-h-full flex-col">
        ...
        >
          <motion.div
            className="border-accent-200 text-accent-600 dark:border-accent-700 dark:bg-accent-900 dark:text-accent-200 mb-3 flex size-10 items-center justify-center rounded-full border bg-white shadow-sm"
            style={{
