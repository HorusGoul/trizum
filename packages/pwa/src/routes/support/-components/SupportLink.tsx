...
export function SupportLink({
  ...
  return (
    <a
      href={href}
      {...linkProps}
      className="bg-accent-50 hover:bg-accent-100 focus-visible:ring-accent-500 dark:bg-accent-900 dark:hover:bg-accent-800 flex gap-4 rounded-lg p-4 transition-colors outline-none focus-visible:ring-2"
    >
