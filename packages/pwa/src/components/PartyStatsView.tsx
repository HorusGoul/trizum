...
function PartyStatsContent({ scrollElementRef }: PartyStatsViewProps) {
  ...
  return (
    <div className="container flex min-h-full flex-col gap-5 px-4 pt-3 pb-24">
      ...
      <section className="border-accent-300/80 from-accent-500 via-accent-600 to-accent-700 text-accent-50 dark:border-accent-500/60 dark:from-accent-700 dark:via-accent-800 dark:to-accent-950 rounded-[1.9rem] border bg-gradient-to-br p-5 shadow-sm lg:p-6 dark:shadow-none">
...
function StatsSummaryCard({
  ...
  if (compact) {
    return (
      <div className="text-accent-50 dark:bg-accent-950/30 inline-flex max-w-full items-center gap-2 self-start rounded-full border border-white/15 bg-white/10 px-3 py-2 shadow-sm backdrop-blur-sm sm:self-start dark:shadow-none">
...
function StatsPodium({ currency, currentParticipantId, first, second, third }: StatsPodiumProps) {
  return (
    <div className="border-accent-200/80 bg-accent-50/80 dark:border-accent-800 dark:bg-accent-950/70 rounded-[1.75rem] border p-4 shadow-sm dark:shadow-none">
...
function StatsEmptyState({ hasAnyTrackedExpense }: StatsEmptyStateProps) {
  return (
    <div className="border-accent-300 dark:border-accent-700 dark:bg-accent-900 rounded-2xl border border-dashed bg-white p-6 text-center shadow-sm dark:shadow-none">
