    ...
    <MediaGalleryContext value={{ state, open, close }}>
      ...
      <ModalOverlay
        ...
        className={({ isEntering, isExiting }) =>
          `absolute left-0 top-0 isolate z-10 h-full w-full bg-black/25 backdrop-blur ${isEntering ? "duration-300 ease-out animate-in fade-in" : ""} ${isExiting ? "duration-200 ease-in animate-out fade-out" : ""} `
        }
      >
