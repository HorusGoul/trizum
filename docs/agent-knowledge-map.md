...
| [`/docs/renovate.md`](./renovate.md)                                                                                                               | Renovate runner requirements and repo-specific dependency-update behavior                                      | Workspace maintainer    | Update in the same PR as dependency automation or Renovate runner assumptions change    |
| [`/.node-version`](../.node-version), [`/mise.toml`](../mise.toml), [`/package.json`](../package.json), and [`/vite.config.ts`](../vite.config.ts) | Node version, native-tooling Ruby version, package manager version, Vite+ config, and workspace-level commands | Workspace maintainer    | Update in the same PR as toolchain or root script changes                               |
...
| [`/packages/agent-workflows/README.md`](../packages/agent-workflows/README.md)                                                                     | Barnum-based agent workflow entry points, CLI usage, and Renovate review automation                            | Workspace maintainer    | Update in the same PR as agent workflow commands or behavior changes                    |
